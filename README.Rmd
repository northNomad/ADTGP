...
ADTGP uses Gaussian process regression to correct droplet-specific technical noise in single-cell protein sequencing data

## Installation

You can install the development version of ADTGP from [GitHub](https://github.com/) with:
...
Using ADTGP to obtain the conditional distribution of CD11b counts where all cells share the same isotype control noise.
